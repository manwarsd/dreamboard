    ...
    def generate_video(
        ...
        if not wait:
            return VideoGenerationResponse(
                ...
                execution_message="The video is generating and process did not "
        ...
        if operation.response:
            ...
            if not operation.result.generated_videos:
                return VideoGenerationResponse(
                    ...
                    operation_name=operation.name,
                    execution_message="Videos were not generated. It could be "
            ...
            return VideoGenerationResponse(
                ...
                operation_name=operation.name,
                execution_message=f"There was an error generating the video: "
                f"{operation.error}",
                videos=[],
                video_segment=video_segment,
            )
